...
Scenario: Standard Edit Role Check between Manager and Mediator
  ...
  And I fill in the text field "question_label" with "Form Color?"
  ...
  And I click the "Manage Custom Fields" link
  And I click the "Text" link
  And I fill in the text field "question_label" with "Line Item Color?"
  And I verify all checkboxes are unchecked
  And I click the "question_issue_field_authorizations_attributes_1_editable" checkbox
  And I click the "SAVE" link
  And I am on the issues page
...
Scenario: Add Multiple Dependent Fields
  ...
  # And I fill in the text field "question_choices_attributes_0_value" with "four"
  # And I click the "question_viewable_in_list" checkbox
  And I fill in the text field "question_choices_attributes_1_label" with "five"
  And I click the "question_viewable_in_list" checkbox
  # And I fill in the text field "question_choices_attributes_1_value" with "five" 
  # And I click the "question_viewable_in_list" checkbox
  And I fill in the text field "question_choices_attributes_2_label" with "six"
  # And I click the "question_viewable_in_list" checkbox
  # And I fill in the text field "question_choices_attributes_2_value" with "six"
  And I click the "question_viewable_in_list" checkbox
  ...
  # And I click the "Manage Custom Fields" link
  # And I click the "Drop List" link
  # And I fill in the text field "question_label" with "LineItem Parent DL"
  # And I fill in the text field "question_choices_attributes_0_label" with "four"
  # And I fill in the text field "question_choices_attributes_0_value" with "four"
  # And I fill in the text field "question_choices_attributes_1_label" with "five"
  # And I fill in the text field "question_choices_attributes_1_value" with "five"  
  ...
  # And I click the "Manage Custom Fields" link
  # And I click the "Text" link
  # And I fill in the text field "question_label" with "LineItem Child Value"
  # And I click the "js_dependency" checkbox
  # And I click the "checkbox js_dependent_question" radio button
  # And I wait for "3" seconds
  # And I click the "question_dependency_answers_1" checkbox
  ...
  # And I select "one" from "issue_form_response_attributes_answers_attributes_0_value"
  # And I wait for "5" seconds
  # And I select "four" from "issue_line_items_attributes_0_form_response_attributes_answers_attributes_0_value"
  # And I click the "SAVE" button
  # 
  # And I wait for "2" seconds 
